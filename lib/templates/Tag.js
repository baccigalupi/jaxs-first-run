...
export default class TagTemplate {
  ...
  render(renderKit) {
    ...
    console.log('Rendering Tag', dom.outerHTML, renderKit.props, renderKit)
  ...
  removeListeners() {
    ...
    // remove on children too!
  }

  rerender(renderKit) {
    this.removeListeners()
    this.dom.innerHTML = ''
    console.log('Re-render Tag', { props: renderKit.props })
    this.children.rerenderIntoParent(this.dom, renderKit)
    return this.dom
  }
}
